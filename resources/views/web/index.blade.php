...
@section('content')
    ...
    <div class="cs-hero cs-style7" id="home">
        ...
        <div class="cs-hero_img_1"><img src="storage/assets/tatweer-img/main-img.png" alt="Hero Img"></div>
        <div class="cs-hero_img_2"><img src="storage/assets/tatweer-img/hero_img_3.png" alt="Hero Img"></div>
        <div class="cs-hero_img_3"><img src="storage/assets/tatweer-img/hero_img_4.png" alt="Hero Img"></div>
    ...
    <section>
        ...
        <div class="container">
            <div class="row align-items-center ">
                <div class="col-lg-5">
                    <img src="storage/assets/tatweer-img/home-abt.jpg" alt="About" class="w-100 cs-radius_5">
                </div>
                <div class="col-lg-6 offset-lg-1">
                    ...
                    <div class="cs-section_heading cs-style1">
                        ...
                        <a href="about.html" class="cs-text_btn wow fadeInLeft" data-wow-duration="0.8s"
                            data-wow-delay="0.2s">
                ...
                <div class="col-xl-8">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="cs-hobble">
                                <div class="cs-card cs-style1 cs-hover_layer1">
                                    <img src="storage/assets/tatweer-img/service_1.jpeg" alt="Service">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="cs-hobble">
                                <div class="cs-card cs-style1 cs-hover_layer1">
                                    <img src="storage/assets/tatweer-img/service_2.jpg" alt="Service">
                                    <div class="cs-card_overlay"></div>
                                    <div class="cs-card_info">
                                        <span class=" cs-hover_layer3 cs-accent_bg"></span>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="cs-hobble">
                                <div class="cs-card cs-style1 cs-hover_layer1">
                                    <img src="storage/assets/tatweer-img/service_5.jpg" alt="Service">
                                    <div class="cs-card_overlay"></div>
                                    <div class="cs-card_info">
                                        <span class=" cs-hover_layer3 cs-accent_bg"></span>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="cs-hobble">
                                <div class="cs-card cs-style1 cs-hover_layer1">
                                    <img src="storage/assets/tatweer-img/service_4.jpeg" alt="Service">
                                    <div class="cs-card_overlay"></div>
                                    <div class="cs-card_info">
                                        <span class=" cs-hover_layer3 cs-accent_bg"></span>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="cs-hobble">
                                <div class="cs-card cs-style1 cs-hover_layer1">
                                    <img src="storage/assets/tatweer-img/service_3.jpg" alt="Service">
                                    <div class="cs-card_overlay"></div>
                                    <div class="cs-card_info">
                                        <span class=" cs-hover_layer3 cs-accent_bg"></span>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="cs-hobble">
                                <div class="cs-card cs-style1 cs-hover_layer1">
                                    <img src="storage/assets/tatweer-img/service_6.jpg" alt="Service">
                                    <div class="cs-card_overlay"></div>
                                    <div class="cs-card_info">
                                        <span class=" cs-hover_layer3 cs-accent_bg"></span>
    ...
    <section>
        <div class="container">
            <div class="cs-funfact_wrap_2 cs-no_shadow">
                <div class="cs-funfact_shape" data-src="storage/assets/img/funfact_shape_bg.svg"></div>
                    ...
                    <div class="cs-slider_wrapper">
                            ...
                            <div class="cs-testimonial cs-style3">
                                <div class="cs-client_info">
                                    <div class="cs-client_img">
                                        <img src="storage/assets/tatweer-img/avatar_5.png" alt="avatar1">
                                    </div>
                                ...
                                <!-- <div class="cs-rating" data-rating="4">
                                              <div class="cs-rating_bg" data-src="storage/assets/img/rating.svg"></div>
                                              <div class="cs-rating_percentage" data-src="storage/assets/img/rating.svg"></div>
                                            </div> -->
                            </div>
                        </div><!-- .cs-slide -->
                        <div class="cs-slide">
                            <div class="cs-testimonial cs-style3">
                                <div class="cs-client_info">
                                    <div class="cs-client_img">
                                        <img src="storage/assets/tatweer-img/avatar_6.png" alt="avatar1">
                                    </div>
                                    <div class="cs-client_meta">
                                        <h4 class="cs-client_name">Leonel Bolian</h4>
                                        <p class="cs-client_designation mb-0">Ninja Shop</p>
                        ...
                        <div class="cs-slide">
                            <div class="cs-testimonial cs-style3">
                                <div class="cs-client_info">
                                    <div class="cs-client_img">
                                        <img src="storage/assets/tatweer-img/avatar_7.png" alt="avatar1">
                                    </div>
                                    <div class="cs-client_meta">
                                        <h4 class="cs-client_name">Leonel Bolian</h4>
                                        <p class="cs-client_designation mb-0">Ninja Shop</p>
                        ...
                        <div class="cs-slide">
                            <div class="cs-testimonial cs-style3">
                                <div class="cs-client_info">
                                    <div class="cs-client_img">
                                        <img src="storage/assets/tatweer-img/avatar_1.png" alt="avatar1">
                                    </div>
                                    <div class="cs-client_meta">
                                        <h4 class="cs-client_name">Leonel Bolian</h4>
                                        <p class="cs-client_designation mb-0">Ninja Shop</p>
    ...
    <div class="cs-cta cs-style1 cs-bg text-center cs-shape_wrap_1 cs-position_1 cs-type_1"
        data-src="storage/assets/tatweer-img/cta_bg_5.jpeg">
