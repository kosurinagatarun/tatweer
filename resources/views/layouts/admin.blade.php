...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('storage/assets/css/plugins/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('storage/assets/css/plugins/fontawesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('storage/assets/css/plugins/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('storage/assets/css/plugins/lightgallery.min.css') }}">
    <link rel="stylesheet" href="{{ asset('storage/assets/css/plugins/animate.css') }}">
...
<body>
                ...
                <div class="cs-main_header_in">
                    <div class="cs-main_header_left">
                        <a class="cs-site_branding" href="{{ url('/') }}">
                            <img src="{{ asset('storage/assets/tatweer-img/tatweer_logo.png') }}" alt="Logo">
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="cs-footer_item">
                            <div class="cs-text_widget">
                                <img src="storage/assets/tatweer-img/tatweer_logo.png" alt="Footer_Logo">
  ...
  v20.341H37.29v27.585h23.814v70.761H89.584z" />
    ...
    <!-- Script -->
    <script src="{{ asset('storage/assets/js/plugins/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('storage/assets/js/plugins/isotope.pkg.min.js') }}"></script>
    <script src="{{ asset('storage/assets/js/plugins/jquery.slick.min.js') }}"></script>
    <script src="{{ asset('storage/assets/js/plugins/jquery.counter.min.js') }}"></script>
    <script src="{{ asset('storage/assets/js/plugins/lightgallery.min.js') }}"></script>
    <script src="{{ asset('storage/assets/js/plugins/wow.min.js') }}"></script>
    <script src="{{ asset('storage/assets/js/plugins/gsap.min.js') }}"></script>
